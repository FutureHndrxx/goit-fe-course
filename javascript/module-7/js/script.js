...
//   const getSortedSkills = skills => skills.sort();

//   const allSkills = getAllSkills(users);

//   const uniqueSkills = getUniqueSkills(allSkills);

//   const sortedSkills = getSortedSkills(uniqueSkills);
...
//   const sortByFriendsCount = array =>
//     array.sort((userA, userB) => userA.friends.length - userB.friends.length);
...
//   const sortedUsers = sortByFriendsCount(users);

//   return userNames(sortedUsers);
// };
